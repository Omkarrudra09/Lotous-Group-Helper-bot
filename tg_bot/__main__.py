...
{} 𝐇𝐞𝐲 𝐖𝐞𝐥𝐜𝐨𝐦 𝐓𝐨 𝐋𝐨𝐭𝐨𝐮𝐬 𝐁𝐨𝐭 {}, 𝐎𝐰𝐧𝐞𝐫 𝐈𝐝 𝐢𝐬 (tg://user?id={})

[𝐑𝐞𝐩𝐨](https://github.com/Omkarrudra09/Lotous-Group-Helper-bot)

𝐈'𝐚𝐦 𝐚 𝐬𝐢𝐦𝐩𝐥𝐞 𝐆𝐫𝐨𝐮𝐩 𝐇𝐞𝐥𝐩𝐞𝐫 𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 𝐑𝐮𝐝𝐫𝐚... 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐔𝐬𝐞 𝐦𝐞 𝐭𝐨 𝐑𝐞𝐩𝐥𝐚𝐜𝐞𝐝 𝐌𝐢𝐬𝐬 𝐑𝐨𝐬𝐞 𝐁𝐨𝐭 .

𝐅𝐨𝐫 𝐦𝐨𝐫𝐞 𝐇𝐞𝐥𝐩 𝐔𝐬𝐞 /help 𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/friends_chat_groupz"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/Mo_Tech_YT")],
                     [InlineKeyboardButton(text="👨‍💻 Make", url="https://t.me/friends_chat_groupz"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
